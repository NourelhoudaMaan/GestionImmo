...
public class FournisseurController implements Serializable {
    ...
    @EJB
    private controller.FournisseurFacade ejbFacade;
    ...
    private List<Fournisseur> filteredfournisseurlList ;

    public List<Fournisseur> getFilteredfournisseurlList() {
        return filteredfournisseurlList;
    }

    public void setFilteredfournisseurlList(List<Fournisseur> filteredfournisseurlList) {
        this.filteredfournisseurlList = filteredfournisseurlList;
    }
